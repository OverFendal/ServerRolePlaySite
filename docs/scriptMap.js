document.addEventListener("DOMContentLoaded", () => {
    ...
    regions.forEach(region => {
        region.addEventListener("click", (e) => {
            ...
            if(title=='11'){
                a = "Королевская Пустыня / Королевство Саркас — северная территория, покрытая песками и древними руинами. Слева — бескрайние барханы, где в забытых пирамидах спят короли прошлого. Их гробницы молчат, но шёпот ветра несёт предостережение: мёртвые не любят, когда их тревожат. Справа — Королевство Саркас, оплот воинственного народа сарацинов. Их королевство ведёт постоянную борьбу за выживание — с тем, что однажды пробудилось.";
